...
To add a site that will be bypassed by the VPN, click on the "  Add". A new line without a domain will be generated in the list of sites. 
...
Click on the  trash can that is one the line of the site that needs to be removed.
