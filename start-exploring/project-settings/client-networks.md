...
Select ![](../../.gitbook/assets/image%20%286%29.png) Add
...
Just select the ![](../../.gitbook/assets/image%20%288%29.png) pencil to the right of the name of the network that you want to modify. Make sure to click on save after any changes.

**Deleting a Network**

Click on the ![](../../.gitbook/assets/image%20%285%29.png) trash can  that is right of the network that needs to be deleted.
