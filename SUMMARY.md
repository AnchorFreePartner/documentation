...
* [Network](console-details/network-locations/README.md)
  ...
  * [Pools](console-details/network-locations/pools/README.md)
    * [Groups of pool](console-details/network-locations/pools/groups-of-pool/README.md)
      * [Request selector \(JSON format\)](console-details/network-locations/pools/groups-of-pool/request-selector-json-format.md)
      * [Server selector \(JSON format\)](console-details/network-locations/pools/groups-of-pool/server-selector-json-format.md)
